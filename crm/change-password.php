...
{
 $sql=mysqli_query($con,"SELECT password FROM  user where password='".md5($_POST['oldpass'])."' && email='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update  user set password='".md5($_POST['newpass'])."' where email='".$_SESSION['login']."'");
