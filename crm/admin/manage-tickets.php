...
<div class="page-container row"> 
            ...
            <div class="grid-body  no-border" style="display:none">
              <div class="post">
                ...
                <div class="info-wrapper">
                  <div class="info"><b> Message by <?php echo $row['email_id'].":</b>".$row['ticket'];?> </div>
                  <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
              </div>
              ...
              <div class="form-actions">
                <div class="post col-md-12">
                  <div class="user-profile-pic-wrapper">
                    <div class="user-profile-pic-normal"> <img width="35" height="35" data-src-retina="assets/img/admin.ico" data-src="assets/img/admin.ico" src="assets/img/admin.ico" alt=""> </div>
                  </div>
                  <div class="info-wrapper">
 <form name="adminr"  method="post" enctype="multipart/form-data">
                     ...
                     <textarea name="aremark" cols="50" rows="4" required="true"><?php echo $row['admin_remark'];?></textarea>
                      <hr>
                      <p class="small-text"> 
                        <input name="update" type="submit"  class="txtbox1" id="Update" value="Give Ticket Feedback" size="40" />
