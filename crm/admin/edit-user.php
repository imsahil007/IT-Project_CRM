...
<td><img src="../assets/img/profile2.png" width="64" height="64"  style="border:solid 1px #000000;" title="No Image available" /></td>
<?php } else { ?>
    <td><img src="../assets/img/<?php echo $rw['user_image'];?>" width="64" height="64"  style="border:solid 1px #000000;" /></td>
  <?php } ?>
  </tr>
