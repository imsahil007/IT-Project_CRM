...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
  ...
  {
    $ret=mysqli_query($con,"SELECT * FROM user WHERE email='".$_POST['email']."' and password='".md5($_POST['password'])."'");
    ...
    if($num>0)
    {
     ...
     $a = "insert into usercheck(logindate,logintime,user_id,username,email,mac) values(\"".$val3."\",\"".$tim."\",\"".$_SESSION['id']."\",\"".$_SESSION['name']."\",\"".$email."\",\"".$mac."\")";
      echo "<script>console.log('".$a."');</script>";
      $ret=mysqli_query($con,$a);
      if($ret)
      {
        ...
        $_SESSION["loggedin"] = true;
         ...
         echo "<script>alert(Error!".$ret.");</script>";
      }
      $extra="dashboard.php";
...
<body class="error-body no-top bg">
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Sign in to CRM</h2>
          <p>
            <a href="registration.php">Sign up Now!</a> Create an account today!</p>
          <br>
