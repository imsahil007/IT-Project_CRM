...
{
  $email = $_POST['email'];
$query = "update user set password='".md5($email)."' where email='".$email."'";
...
$message = "Your password is set to '".$email. "'. Kindly change it after logging in!";
// mail($email, $subject, $message, "From: $email");
$_SESSION['msg']= "Your Password has been recovered Successfully.";
