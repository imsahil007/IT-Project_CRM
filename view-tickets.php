         ...
         <div class="content">
            ...
            <div class="row">
               <div class="col-md-12">
                     ...
                     <div class="grid-body  no-border" style="display:none">
                        <div class="post">
                           <div class="user-profile-pic-wrapper">
                              <div class="user-profile-pic-normal"> <img width="35" height="35" data-src-retina="assets/img/profile.png" data-src="assets/img/profile.png" src="assets/img/profile.png" alt=""> </div>
                           </div>
                        ...
                        <div class="form-actions">
                           <div class="post col-md-12">
                              <div class="user-profile-pic-wrapper">
                                 <div class="user-profile-pic-normal"> <img width="35" height="35" data-src-retina="assets/img/admin.ico"
                                    data-src="assets/img/admin.ico" src="assets/img/admin.ico" alt=""> </div>
                              </div>
                              <div class="info-wrapper">
                                 <br>
                                 <?php echo $row['admin_remark'];?>
                                 <hr>
                                 <p class="small-text">Admin Remark Date on <?php echo $row['admin_remark_date'];?></p>
                              </div>
                              <div class="clearfix"></div>
                           </div>
                           <div class="clearfix"></div>
                  ...
                  <?php } } else {?>
                  <h3 style="align:center;color:red;">No Record found</h3>
                  <?php } ?>                
               </div>
            </div>
         </div>
