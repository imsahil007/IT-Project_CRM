        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Manage <span class="semi-bold">Quotes</span></h4>
              <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
            </div>
            <div class="grid-body ">
            <div class="form-row row align-items-center">
              <div class="col-auto">
                <input type="text" id="search" onkeyup="showResult(this.value)" class="form-control mb-2" id="inlineFormInput" placeholder="Search via Name/Email/Contact No.">
              </div>
...
<script>
  ...
  xhr.open("POST","searchquotes.php",true);
