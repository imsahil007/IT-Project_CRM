<?php
   ...
   if(isset($_POST['submit']))
   {
      ...
      $ret = mysqli_query($con,"insert into user(name,email,password,mobile,gender) values('$name','$email','$password','$mobile','$gender')");
      if($ret){
...
<html>
   ...
   <body class="error-body no-top bg">
      <div class="container">
      <div class="row signup-container column-seperation mt-0 pt-0">
         <!-- <div class="row"> -->
            <div class="col-md-5 col-md-offset-1">
               <h2>Sign Up to CRM</h2>
               <p>            <a href="index.php">Sign in Now!</a> Already an User?</p>
               <br>
            </div>
         <!-- </div> -->
         <!-- <div class='row'> -->
